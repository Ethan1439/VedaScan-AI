            ...
            properties: {
              ...
              medicines: {
                ...
                items: {
                  type: import_genai.Type.OBJECT,
                  properties: {
                    name: { type: import_genai.Type.STRING, description: "Common English or standard Ayurvedic herb name." },
                    sanskritName: { type: import_genai.Type.STRING, description: "Sanskrit botanical name transliteration." },
                    type: { type: import_genai.Type.STRING, description: "Remedy Type (e.g., Single Herb, Churna Powder, Decoction, Tablet)." },
                    benefits: { type: import_genai.Type.STRING, description: "Why it matches this patient's symptoms/disease." },
                    dosageInstructions: { type: import_genai.Type.STRING, description: "Dosage, carrier (Anupana), frequency, and time of day." },
                    safetyNotes: { type: import_genai.Type.STRING, description: "Warnings, pregnancy advice, or chronic considerations." }
                  },
              ...
              dietaryRecommendations: {
                type: import_genai.Type.OBJECT,
                properties: {
                  explanation: { type: import_genai.Type.STRING, description: "Food guidance philosophy regarding Agni and digestive toxins." },
                  toFavor: { type: import_genai.Type.ARRAY, items: { type: import_genai.Type.STRING }, description: "List of optimal diets, spices, drinks to consume." },
                  toAvoid: { type: import_genai.Type.ARRAY, items: { type: import_genai.Type.STRING }, description: "List of foods to avoid based on symptoms." }
                },
              ...
              lifestyleRecommendations: {
                type: import_genai.Type.OBJECT,
                properties: {
                  yogaAsanas: { type: import_genai.Type.ARRAY, items: { type: import_genai.Type.STRING }, description: "Soothed yoga stretches." },
                  breathingExercises: { type: import_genai.Type.ARRAY, items: { type: import_genai.Type.STRING }, description: "Resonating Pranayama techniques." },
                  lifestyleTips: { type: import_genai.Type.ARRAY, items: { type: import_genai.Type.STRING }, description: "Recommended habits, sleeping, body therapy." }
                },
      ...
      const response = await client.models.generateContent({
        ...
        config: {
          ...
          responseSchema: {
            type: import_genai.Type.OBJECT,
            properties: {
              message: { type: import_genai.Type.STRING, description: "Detailed supportive therapeutic dialogue text in markdown format." },
              sattvaLevel: { type: import_genai.Type.INTEGER, description: "Estimated self-control/willpower index on a scale of 0 to 100." },
              cravingAntidotes: {
                type: import_genai.Type.OBJECT,
                properties: {
                  physical: { type: import_genai.Type.STRING, description: "Immediate physical herbal or sensory gesture antidote." },
                  breathWork: { type: import_genai.Type.STRING, description: "Targeted crave-disruption Pranayama guidelines." },
                  mentalFocus: { type: import_genai.Type.STRING, description: "Mindful cognitive focus or visualization technique." }
                },
...
function generateMockRecommendation(symptoms, disease, severity, story) {
...
function generateMockHabitResponse(habit, messages) {
